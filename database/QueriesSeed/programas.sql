...
-- ==========================================
-- 1. INSTITUTIONAL & ACADEMIC FOUNDATION
-- ==========================================
INSERT INTO regional (id, nombre) VALUES ('019d8dfb-3652-7e61-831d-b8d28e7e5900', 'REGIONAL DISTRITO CAPITAL') ON CONFLICT DO NOTHING;
INSERT INTO centro (id, regional_id, nombre) VALUES ('019d8dbc-dde7-72a6-96af-5f2474b45781', '019d8dfb-3652-7e61-831d-b8d28e7e5900', 'CENTRO DE SERVICIOS FINANCIEROS') ON CONFLICT DO NOTHING;
INSERT INTO coordinacion (id, centro_id, nombre) VALUES ('019d8dfb-3652-7e61-831d-b8d28e7e5908', '019d8dbc-dde7-72a6-96af-5f2474b45781', 'COORDINACION DE TURISMO Y SERVICIOS') ON CONFLICT DO NOTHING;
...
INSERT INTO proyecto_formativo (id, codigo, nombre) VALUES 
    ...
    ('019d8e05-9988-7561-831d-b8d28e7e5913', 'PF-PELUQUERIA-002', 'COSMETOLOGIA PELUQUERIA Y ESTILO') 
ON CONFLICT DO NOTHING;

-- ==========================================
-- 4. FICHAS (Linking everything together)
-- ==========================================
INSERT INTO ficha_formacion (id, numero, programa_formacion_id, coordinacion_id, proyecto_formativo_id, instructor_id) VALUES 
    ...
    (gen_random_uuid(), '4100992', '019d8e1a-4422-7e61-831d-b8d28e7e5921', '019d8dfb-3652-7e61-831d-b8d28e7e5908', '019d8e2b-7711-7e61-831d-b8d28e7e5932', '019d8dbc-debc-7015-a67c-39159edf3738')
ON CONFLICT DO NOTHING;
